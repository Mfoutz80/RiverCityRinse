        ...
        async function getJettResponse(question) {
          try {
            ...
            const fallbackResponses = [
              "Splash! My cleaning connection's a bit clogged. Try again?",
              "Whoosh! Something's off. Maybe I got sidetracked by a stubborn stain?",
              "Spray! My system’s a little backed up. I’ll clear it out soon.",
              "Drip! I’m tangled in a hose right now. Ask again in a sec?",
              "Blast! I’m tackling some grime. Can you try again shortly?"
              ];
